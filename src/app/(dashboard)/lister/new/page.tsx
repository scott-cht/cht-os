              ...
              <div>
                ...
                <div className="flex gap-3">
                  <Input
                    ...
                    placeholder="e.g., Marantz AV30 or paste a product URL"
                    className="flex-1"
                  />
              ...
              {searchQuery.startsWith('http') && (
                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
                  <p className="text-sm text-emerald-700 dark:text-emerald-400 mb-2">
                    Detected URL - scrape directly?
                  </p>
                  <Button
                    onClick={() => handleScrape(searchQuery)}
              ...
              <div className="mt-6 space-y-3">
                ...
                {searchResults.map((result, i) => (
                  <button
                    ...
                    disabled={isScraping}
                    className="w-full p-4 text-left bg-zinc-50 dark:bg-zinc-800 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors disabled:opacity-50"
                  >
