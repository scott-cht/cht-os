    ...
    <Shell title="Product Lister" subtitle="Choose listing type">
      <div className="max-w-3xl mx-auto py-8">
        ...
        <div className="grid gap-4">
          ...
          <Link
            href="/lister/ex-demo"
            className="group p-6 bg-white dark:bg-zinc-900 rounded-xl border-2 border-zinc-200 dark:border-zinc-800 hover:border-purple-500 dark:hover:border-purple-500 transition-all hover:shadow-lg"
          >
            <div className="flex items-start gap-5">
              <div className="w-16 h-16 rounded-xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                🏷️
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white group-hover:text-purple-600 transition-colors">
                  Ex-Demonstration Unit
                </h3>
                <p className="text-zinc-600 dark:text-zinc-400 mt-1 mb-3">
                  Former showroom or demo unit. Same workflow as trade-in with ex-demo tagging.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 text-xs rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400">
                    Camera Capture
              ...
              <svg className="w-6 h-6 text-zinc-400 group-hover:text-purple-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
          </Link>
